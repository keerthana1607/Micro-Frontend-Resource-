// src/pages/ProjectsTracking.jsx
...
//                             .filter(emp => emp.role === 'employee') // Filter employees only
...
//     const handleRemoveProject = async (projectId, taskDetails) => {
//         try {
//             // Step 1: Delete the project
//             const projectDeleteResponse = await fetch(`http://localhost:7777/project/${projectId}`, {
//                 method: 'DELETE',
//             });
...
//             // Step 2: Collect all status IDs
//             const statusIds = [];
//             for (const employeeId in taskDetails) {
//                 taskDetails[employeeId].forEach(task => {
//                     statusIds.push(task.statusId);
//                 });
//             }

//             // Step 3: Delete all status records
//             const statusDeletePromises = statusIds.map(statusId =>
//                 fetch(`http://localhost:7777/status/delete/${statusId}`, {
//                     method: 'DELETE',
//                 })
//             );
...
//             // Optionally, you can remove the project from the state after successful deletion
...
//                 icon: 'error',
//                 title: 'Remove Error',
//                 text: 'An error occurred while removing the project or its tasks.',
//                 confirmButtonText: 'OK'
//             });
//         }
//     };
...
//         const hasEmployee = project.emp && project.emp.some(employee => employee.role === 'employee');
//         if (hasEmployee) return 'Project Allocated';

//         const hasRole = project.emp && project.emp.some(employee => employee.role === 'project manager');
//         return hasRole ? 'Pending' : 'Completed';
//     };
...
//                                         </Typography>
//                                         <Typography variant="body1" color="textSecondary">
//                                             <strong>Status:</strong> {getProjectStatus(project)}
//                                         </Typography>
//                                         <Button
//                                             variant="contained"
//                                             color="primary"
...
//                             color="secondary"
//                             style={{ marginTop: '20px' }}
//                             onClick={() => handleRemoveProject(selectedProject.projectId, taskDetails)}
//                         >
//                             Remove Project
//                         </Button>
//                         <Typography variant="h6" component="h3" style={{ marginBottom: '20px' }}>
...
//     const [projectRemoved, setProjectRemoved] = useState(false); // Track if a project was removed
...
//         fetchAllProjects();
//     }, [projectRemoved]); // Refresh projects list when project is removed
...
//                 setProjectRemoved(true); // Trigger UI update
//                 setSelectedProject(null);
//                 Swal.fire({
//                     icon: 'success',
//                     title: 'Removed',
