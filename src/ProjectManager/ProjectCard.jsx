...
//                 <Button 
//                     variant="contained"
//                     color={tasksConfirmed ? 'default' : 'secondary'}
//                     style={{ 
//                         marginTop: '10px', 
//                         backgroundColor: tasksConfirmed ? '#4caf50' : '#ffa31a', 
//                         color: '#ffffff'
//                     }} 
//                     onClick={() => !tasksConfirmed && onCreateTask(project.projectId)} 
//                     disabled={tasksConfirmed}
//                 >
//                     {tasksConfirmed ? 'Tasks Confirmed' : 'Create Task'}
//                 </Button>
//             </CardContent>
//         </Card>
//     );
...
//                 setProjects([...projects, projectData]); // Add the new project to the list
//                 handleCloseProjectModal();
//                 handleOpenTaskModal(projectData.projectId); // Open task modal for the new project
//             } else {
...
//                         Cancel
//                     </Button>
//                     <Button onClick={handleCreateTasks} color="primary">
//                         Create Tasks
//                     </Button>
//                 </DialogActions>
//             </Dialog>
...
import React, { useState, useEffect } from 'react';
import Swal from 'sweetalert2';
import { Button, Card, CardContent, Typography, Dialog, DialogTitle, DialogContent, DialogActions, TextField, Chip, Select, MenuItem, InputLabel } from '@mui/material';
import ProjectDashboard from './ProjectDashboard'; // Import ProjectDashboard component
...
const ProjectTable = () => {
    ...
    const [newProject, setNewProject] = useState({
        ...
        startDate: '',
        endDate: '',
        requirementSkills: '', // Change this to hold a single string value for simplicity
        members: '', // Initial empty string, will convert to number
        projectStatus: 'Pending', // Default value
        userId: null // Initialize as null
    });
    ...
    const handleCloseProjectModal = () => {
        ...
        setNewProject({
            ...
            startDate: '',
            endDate: '',
            requirementSkills: '', // Reset to empty string
            members: '',
            projectStatus: 'Pending',
            userId: newProject.userId
        });
            ...
            <div>
                ...
                <Dialog open={openProjectModal} onClose={handleCloseProjectModal}>
                    ...
                    <DialogContent>
                        ...
                        />
                        <InputLabel id="requirementSkills-label">Skills Required</InputLabel>
                        <Select
                            labelId="requirementSkills-label"
                            name="requirementSkills"
                            value={newProject.requirementSkills}
                            onChange={handleInputChange}
                            fullWidth
